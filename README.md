...
The repository includes [`bob_sessions/`](./bob_sessions/) evidence for all material IBM Bob implementation milestones, with hashes and timestamps recorded in [`bob_sessions/manifest.json`](./bob_sessions/manifest.json).
